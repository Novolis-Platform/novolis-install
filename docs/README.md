# novolis-install documentation

Cross-platform `novolis` installer CLI.

Published docs: [https://novolis-platform.github.io/.github/novolis-install/](https://novolis-platform.github.io/.github/novolis-install/)
